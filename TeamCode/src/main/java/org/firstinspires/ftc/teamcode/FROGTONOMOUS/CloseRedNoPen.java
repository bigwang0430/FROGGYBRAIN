...
@Autonomous (name = "Close Red No Penalties")
public class CloseRedNoPen extends CommandOpMode {
    ...
    public void buildpath(){
        ...
        Path8 = follower.pathBuilder().addPath(
                        new BezierLine(
                                ...
                                new Pose(51.1588785046729, 79.85).mirror()
                        )
                ).setConstantHeadingInterpolation(Math.toRadians(0))
